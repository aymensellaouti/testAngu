...
<head>
    ...
    <title>Inscription Sehelheteshel</title>
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1>Inscription à Sehelheteshel </h1>
                <ol class="breadcrumb">
                    <li><a href="index.html"><i class="icon-dashboard"></i> S'inscrire</a></li>
                    <li class="active"><i class="icon-file-alt"></i>S'inscrire</li>
                </ol>
            </div>
        </div><!-- /.row -->
        <div class="row">
